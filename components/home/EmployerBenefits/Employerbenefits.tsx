          ...
          <div className="rounded-[32px] bg-gradient-to-br from-blue-50 to-violet-50 p-10 shadow-xl">
            <div className="grid grid-cols-2 gap-6">
              <div className="rounded-3xl bg-white p-6 shadow-lg">
                <p className="text-sm text-slate-500">Job Applicants</p>
                <h3 className="mt-2 text-4xl font-bold">250+</h3>
              </div>

              <div className="rounded-3xl bg-white p-6 shadow-lg">
                <p className="text-sm text-slate-500">Match Accuracy</p>
                <h3 className="mt-2 text-4xl font-bold">98%</h3>
              </div>
              ...
              <div className="col-span-2 rounded-3xl bg-white p-6 shadow-lg">
                ...
                <div className="h-3 rounded-full bg-slate-100">
                  <div className="h-3 w-[92%] rounded-full bg-gradient-to-r from-blue-600 to-violet-600" />
                </div>
              </div>
            </div>
          </div>
